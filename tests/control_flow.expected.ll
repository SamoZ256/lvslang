...
define %FragmentOut @testControlFlow(ptr addrspace(2) nocapture noundef readonly "air-buffer-no-alias" %myBuffer) local_unnamed_addr #0 {
  ...
  %_263 = load float, ptr addrspace(2) %myBuffer, align 4
  %op3 = fcmp ogt float %_263, 0.000000e+00
  %op4 = fcmp olt float %_263, 0.000000e+00
  ...
  %_279.fca.0.insert = insertvalue %FragmentOut poison, <4 x float> %outColor.0, 0
  ret %FragmentOut %_279.fca.0.insert
}
