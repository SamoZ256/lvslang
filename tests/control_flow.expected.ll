...
define %FragmentOut @testControlFlow(ptr addrspace(2) nocapture noundef readonly "air-buffer-no-alias" %myBuffer) local_unnamed_addr #0 {
  ...
  %_51 = load float, ptr addrspace(2) %myBuffer, align 4
  %op3 = fcmp ogt float %_51, 0.000000e+00
  %op4 = fcmp olt float %_51, 0.000000e+00
  ...
  %_67.fca.0.insert = insertvalue %FragmentOut poison, <4 x float> %outColor.0, 0
  ret %FragmentOut %_67.fca.0.insert
}
