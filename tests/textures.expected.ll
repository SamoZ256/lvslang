...
entry:
  ...
  %0 = tail call <4 x float> @air.sample_texture_2d.v4f32(ptr addrspace(1) %tex1, ptr addrspace(2) %smp, <2 x float> %fragmentIn.fca.1.extract, i1 true, <2 x i32> zeroinitializer, i1 false, float 0.000000e+00, float 0.000000e+00, i32 0)
  %1 = tail call <4 x float> @air.read.t1f32(ptr addrspace(1) %tex2, <2 x i16> zeroinitializer)
  %op = fmul <4 x float> %0, %1
  ret <4 x float> %op
}
...
!9 = !{ptr @fragmentMain.sVertexOut.t1f32.t1f32.sm, !10, !11}
!10 = !{!12}
!11 = !{!13, !14, !15, !16, !17}
...
!15 = !{i32 2, !"air.texture", !"air.location_index", i32 0, i32 1, !"air.sample", !"air.arg_type_name", !"texture2D<float>", !"air.arg_name", !"tex1"}
!16 = !{i32 3, !"air.texture", !"air.location_index", i32 1, i32 1, !"air.read", !"air.arg_type_name", !"texture2D<float>", !"air.arg_name", !"tex2"}
!17 = !{i32 4, !"air.sampler", !"air.location_index", i32 0, i32 1, !"air.arg_type_name", !"sampler", !"air.arg_name", !"smp"}
!18 = !{!"air.compile.denorms_disable"}
!19 = !{!"air.compile.fast_math_disable"}
