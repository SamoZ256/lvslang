...
define i1 @forwardDeclaredFunction(i32 %a0, <3 x i32> %b) local_unnamed_addr #0 {
  %_13 = extractelement <3 x i32> %b, i64 0
  %op = icmp eq i32 %_13, %a0
  %_16 = extractelement <3 x i32> %b, i64 1
  %op0 = icmp eq i32 %_16, %a0
  %op1 = or i1 %op, %op0
  %_19 = extractelement <3 x i32> %b, i64 2
  %op2 = icmp eq i32 %_19, %a0
  %op3 = or i1 %op2, %op1
  ret i1 %op3
}
