...
#define TOKEN_ATTRIB_ENUM_MIN TOKEN_ATTRIB_DESCRIPTOR_SET
...
enum Token {
    ...
    // '[[attrib]]'
    TOKEN_ATTRIB_POSITION = -110,
    TOKEN_ATTRIB_INPUT = -111,
    TOKEN_ATTRIB_OUTPUT = -112,
    TOKEN_ATTRIB_DESCRIPTOR_SET = -113,
